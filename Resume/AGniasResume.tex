...
\section{PROFILE}
Software engineer with 5+ years of experience. Knowledge of multiple languages and frameworks, with a strong ability to think Pythonically. 
...
\begin{itemize} \itemsep -2pt % reduce space between items
	\item Recreate a CNN from an academic paper in order to retrain it with an augmented dataset
\end{itemize}
...
\begin{itemize} \itemsep -2pt % reduce space between items
	\item Resolve issues related to utility data scrapers written in Python
